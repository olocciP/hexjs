...
const rubd = function (p) { return new rubd.fn.init(p); };
rubd.fn = rubd.prototype = {
  constructor: rubd,
...
const init = (rubd.fn.init = function (p) {
  if (!p) { return this; }
...
///
/// C L A S S - R U B B E R - B A N D /// /// /// /// /// /// /// /// ///
///

const dots = []; /// tangrams
dots.lst = []; /// list 
dots.rtt = [{ x: 0, y: 0, a: 0 }]; /// rotate
dots.tcn = [0, 3]; /// thickness
dots.clr = [ /// color
  '#ee7439', '#e62d8b', '#e9d226', '#7caa2a', '#45537b', '#2d91b7', '#e71223',
  '#ffffff', '#000000'
];
dots.size = [256, 128, 64];
dots.align = [{ w: 0, h: 0, x: 0.5, y: 0.5 }, { w: 0, h: 0, x: 0, y: 0 }];
